...
def validate_data(age, investment_amount, intent_request):
    """
    Validate the data provided the users
    """
    # Validate that the user is over 18 years old and less than 100 years
    ...
    if age is not None:
        ...
        if age <=0 :
            ...
            return build_validation_result(
                False,
                "age",
                "You should be less than  65 years old to plan for retirement, "
                "please provide a different age."
                )
